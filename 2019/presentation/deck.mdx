...
[https://massive-magic.surge.sh/](https://massive-magic.surge.sh/12)
...
- _Day 17: Set and Forget_
  - **Int Code**: Navigating through crossing paths
...
- Int Code machine problems 💻

[intCode.js](https://github.com/icyJoseph/advent-of-code/blob/master/js/intCode.js)
...
- Practice: requirements ➡️ abstractions
